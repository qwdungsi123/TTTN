            ...
            <div class="row">
                <div class="navbar">
                    <ul class="nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/profile.php?id=100009799218203">Fanpage</a></li>
                        <li class="nav-item dropdown subnav-item">
                ...
                <div class="show-nav-res js-nav-social">
                    <ul class="nav-row row js-row-social">
                        ...
                        <li class="col-md-10 nav-row-item">
                            <a href="mailto: luonghieu010202@gmail.com">luonghieu010202@gmail.com</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="container">
                <div class="row mx-0">
                    <div class="col-md-5">
                        <p>
                            ...
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-envelope"></i>Email:<a class="row-bottom-2" href="mailto: luonghieu010202@gmail.com"> luonghieu010202@gmail.com</a></span>
                        </p>
                        <p>
                            ...
                            <span>&emsp;&emsp;<i class="mr-3 fas fa-envelope"></i>Email:<a class="row-bottom-2" href="mailto: dttai.20it10@vku.udn.vn"> luonghieu010202@gmail.com</a></span>
                        </p>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row container">
                    <div class="col-md-4 px-4 text-center social-footer">
                        <a href="https://www.facebook.com/profile.php?id=100009799218203"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="col-md-6 copyright">Coppyright©2023 by nhóm 8 PMMNM  </div>
                </div>
            </div>
        </div>
        <div class="row-bottom">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <a class="row-bottom-2" href="mailto: luonghieu010202@gmail.com"> luonghieu010202@gmail.com</a>
                </div>
            </div>
        </div>
    </footer>
